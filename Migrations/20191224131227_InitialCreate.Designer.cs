...
namespace December_24_2019_Football.Migrations
{
    ...
    [Migration("20191224131227_InitialCreate")]
            ...
            modelBuilder.Entity("December_24_2019_Football.Models.FootballCart", b =>
                {
                    ...
                    b.HasData(
                        new { Id = 1, CartId = 1, FootballPlayerId = 1 },
                        new { Id = 2, CartId = 2, FootballPlayerId = 2 },
                        new { Id = 3, CartId = 1, FootballPlayerId = 3 },
                        new { Id = 4, CartId = 2, FootballPlayerId = 4 },
                        new { Id = 5, CartId = 1, FootballPlayerId = 5 },
                        new { Id = 6, CartId = 2, FootballPlayerId = 6 },
                        new { Id = 7, CartId = 1, FootballPlayerId = 7 },
                        new { Id = 8, CartId = 2, FootballPlayerId = 8 }
                    );
                });
